...
function f_tcalHide (n_date) {
	...
	// teachassist modification - submit the form
	if (n_date) {
		if (changed) {
			if (confirm('Data on this pages has changed, are you sure you want to continue?')) {
				document.forms[this.a_cfg.formname].submit();
			} else {
